...
empDataApp.controller('browseEmpData', ['$scope', '$http', 'showHTMLcontent', function($scope, $http, showHTMLcontent) {
	/*
	$scope.searchResult = $scope.empData = EmployeeDataService{};
		$scope.title = "Employee Data Navigation";
...
/*
empDataApp.service('EmployeeDataService', function EmployeeDataService() {
	return function getEmployeeData() {
		$http.get('employeeData-depth5.json').success(function(data) {
